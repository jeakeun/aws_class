...
public class EX02_String {
	...
	public static void main(String[] args) {
		 ...
		 *   예시
		 *   String str = "abc";
		 *   str =str + "d"; // abc뒤에 d를 이어 붙이는게 아니라 abcd라는 문자열을 새로 만들어 연결
		 *   
		 * StringBuffer(쓰레드지원)와 StringBuilder(쓰레드지원x) p.380
		 * - char[]로 문자열을 관리
		 * - 둘의 차이는 쓰레드 지원여부
		 * 
		 * String 클래스 메서드
		...
		System.out.println("str1에 str2가 몇번지부터 시작됩니까?" +str1.equals(str2));
