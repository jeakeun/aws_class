...
public class EX06_List {
	...
	public static void main(String[] args) {
		/* List를 이용하여 1~5사이의 정수를 입력받아 중복이 안되면 저장하고 중복이 되면 저장하지 않는 예제를 작성하세요.
		 * 과정1. 앞 에제를 활용하여 정수를 5번 입력받는 코드 구현
		...
		// 다른 패키지에서 사용할떄 EX06_List. < 파일명. 으로 써야 사용가능
