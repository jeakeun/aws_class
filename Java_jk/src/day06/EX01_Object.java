...
public class EX01_Object {
	...
	public static void main(String[] args) {
		 ...
		 * - Object에 있는 메서드를 사용 또는 오버라이딩 하여 사용
		 * 
		 * equals(클래스명 객체) p.367
		 * - 객체를 비교할 때 사용하는 메서드 
		 * - Object.equals는 주소를 비교
		 * 	 => 메서드 오버라이딩(재정의)해서 필드르 비교하여 같다와 같지 않다를 판별
		 * 
		 * toString() p.363
...
class Car{
	...
	public boolean equals(Object obj) {
		...
		// 차명이 있고, 차명과 비교대상 차명이 같고, 연식이 같은면 참 아니면 거짓
		//return carName != null && equals(other.carNme) && year == other.year;
	}

	@Override
	public String toString() {
		return " [회사 : " + company + ", 차명 : " + carName + ", 연도 :" + year + ", getClass()=" + getClass()
