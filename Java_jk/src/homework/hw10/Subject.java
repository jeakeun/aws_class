...
public class Subject {
	...
	// grade, semeter, name의 getter와 setter를 추가
	
	// toString 오버라이딩해서 1학년 1학기 국어 형태의 결과를 문자열이
	// 반환되도록 작성하세요.
	@Override
	public String toString() {
		return grade + " 학년 " + semester + " 학기 " + name + " 과목 " ;
	}

	
	// 학년, 학기, 과목를 이용한 생성자를 추가하세요.
	...
	public boolean equals(Object obj) {
		...
		if ( obj instanceof SubjectScore) {
			SubjectScore suSocre = (SubjectScore) obj;
			return this.equals(suSocre.getSubject());
		}
