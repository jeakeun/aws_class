 ...
 * int
 * - 정수를 저장
 * - 대충 -2,000,000,000 ~ 2,000,000,000 을 넘으면 long
 * 
 * double
 * - 소수점 15자리 유효
 * - 실수를 저장
 ...
 * 
 * 변수명 작성 관례
 * - 카멜 표기법 : 두번째 단어부터 첫글자를 대문자로 예=> helloWorld
 * */
	public static void main(String[]args) {
		...
		long num2 = 12345678901L; // 접미사 대문자L 또는 소문자l을 붙여야 함
		...
		float num5 = 1.234f; // 접미사 대문자F 또는 소문자f를 붙여야 함
