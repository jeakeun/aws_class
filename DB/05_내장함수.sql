...
# IFNULL(수식1, 수식2) 
# - 수식1이 null이 아이면 수식1을, NULL이면 수식2를 반환
...
# FORMAT(숫자, 소수점자리수) : 숫자를 소주점 이하 자리까지 표현, 1000단위마다 ,추가
...
# REPLACE(문자열, 문자열A, 문자열B) : 문자열에서 문자열A를 찾아서 문자열B로 교체
...
# DATE/TIME(날짜) : 날짜에서 년-월=알/시:분:초를 추출
...
# - 기준날짜에서 INTERVAL만큼 더한/뺸 날짜
# - INTERVAL 종류
#   - 시간유형
#	  - TEAR/MONTH/DAY : 년/월/일
